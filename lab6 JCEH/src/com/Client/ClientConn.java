                ...
                while (true) {
                    ...
                    if (parsedCommand[0].equals("add")) {
                        ...
                        Flat flat = new Flat(receiver.receiveId(), receiver.receiveName(), receiver.receiveCoordinates(),
                                ZonedDateTime.now().toString(), receiver.receiveArea(), receiver.ReceiveNumberOfRooms(),
                                receiver.receiveLivingSpace(), receiver.receiveFurnish(), receiver.receiveView(), receiver.receiveHOUSE());
                        ...
                        Flat flat = new Flat(id, receiver.receiveName(), receiver.receiveCoordinates(),
                                ZonedDateTime.now().toString(),receiver.receiveArea(), receiver.ReceiveNumberOfRooms(),
                                receiver.receiveLivingSpace(), receiver.receiveFurnish(), receiver.receiveView(), receiver.receiveHOUSE());
                        StringBuilder result = new StringBuilder();
                        XmlMapper mapper = new XmlMapper();
