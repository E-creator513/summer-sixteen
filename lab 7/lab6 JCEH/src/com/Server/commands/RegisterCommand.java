...
public class RegisterCommand extends AbstractCommand {
    ...
    public synchronized String execute(String arg) {
        try {
            ...
            email.validate();
            String password = KingPasswordMan.generateNewPassword();
            try (Connection connection = KingDatabaseMan.getInstance().getConnection()) {
                ...
                try {
                    request.setString(2, KingPasswordMan.getHash(password, "SHA512"));
