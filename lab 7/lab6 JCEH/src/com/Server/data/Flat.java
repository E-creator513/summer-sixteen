...
public class Flat {
     ...
     * @param s
     * @param height
     * @param numberOfRoomseye
     * @param view
     * @param furnish
     * @param house*/
    public Flat(int id, String name, Coordinates coordinates, String s, long height, int numberOfRoomseye, View view, Furnish furnish, House house) {
