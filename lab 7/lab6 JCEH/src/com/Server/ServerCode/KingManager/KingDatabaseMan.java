...
public class KingDatabaseMan {


        private String DB_URL;
        private String USER;
        private String PASSWORD;
        private static volatile KingDatabaseMan instance;
         ...
         */
        public static KingDatabaseMan getInstance() {
            KingDatabaseMan instance2 = instance;
            if (instance2 == null) {
                synchronized (KingDatabaseMan.class) {
                    instance2 = instance;
                    if (instance2 == null) instance = instance2 = new KingDatabaseMan();
                }
            }
            return instance;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof KingDatabaseMan)) return false;
            KingDatabaseMan manager = (KingDatabaseMan) o;
